...
npm config set proxy http://bocheka:Welcome3044@ps-bxl-usr.cec.eu.int:8012
npm config set https-proxy http://bocheka:Welcome3044@ps-bxl-usr.cec.eu.int:8012
